<?php  //[STAMP] 8d4f8ab035136df698b496f0e27ada83
...
trait RestApiTesterActions
{
     ...
     *
     *
     * @see \tests\Helper\RestApi::amUserLogin()
     */
    public function amUserLogin($mobile) {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amUserLogin', func_get_args()));
    }
     ...
     *
     *
     * @see \tests\Helper\RestApi::amTouristLogin()
     */
    public function amTouristLogin($deviceId) {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amTouristLogin', func_get_args()));
    }
